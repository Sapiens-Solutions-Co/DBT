...
description = """Adapter plugin for dbt for additional delta logic in Greenplum and Clickhouse"""
...
setup(
    ...
    url="https://github.com/Sapiens-Solutions-Co/DBT",
    packages=find_namespace_packages(include=["dbt", "dbt.*"]),
    package_data={
        "dbt": [
            "include/greenplum/dbt_project.yml",
            "include/greenplum/sample_profiles.yml",
            "include/greenplum/profile_template.yml",
